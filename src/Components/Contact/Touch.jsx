        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="bg-blue-700 text-white p-8 md:p-12">
            ...
            <div className="bg-white rounded-lg overflow-hidden">
              ...
              <div className="bg-gradient-to-br from-blue-100 to-blue-200 h-64 flex items-center justify-center text-gray-600 relative overflow-hidden">
                ...
                <MapPin className="w-16 h-16 text-red-600 z-10 drop-shadow-lg" />
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center pt-4">
                <button
                  ...
                  className="bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-bold py-3 px-16 rounded-md transition duration-300 shadow-md hover:shadow-lg"
                >
                  SUBMIT
                </button>
              </div>
